...
if __name__ == "__main__":
    ...
    L_factors = [0.5, 2.0, 5.0] # Para que la L sea proporcional al vecindario, como se ha mencionado en clase
    ...
    csv_path = "./test_files/SA_hiperparameter_combinations.csv"
